      ...
      <div class="carousel-inner mb-3">
        ...
        <div class="carousel-item" id="carrossel-item" data-bs-interval="7000">
          <img src="img/biblioteca2.jpg" class="d-block w-100" style="pointer-events: none; object-fit: cover; max-height: 400px; filter: blur(0.5px);" alt="Foto de um CNC por dentro">
           <div class="carousel-caption d-block d-md-block">
            <h3 id= "carousel-title2">BiblioOH&reg;</h3>
        ...
        <div class="carousel-item" id="carrossel-item" data-bs-interval="7000">
          <img src="img/biblioteca3.jpg" class="d-block w-100" style="pointer-events: none; object-fit: cover; max-height: 400px; filter: blur(0.5px);" alt="Foto de um CNC por dentro">
           <div class="carousel-caption d-block d-md-block">
            <h3 id= "carousel-title3">BiblioOH&reg;</h3>
                ...
                ?>
                        <form method="post">
                            <tr>
                                ...
                                <td><p id="dias_restantes<?php echo $livro_mostrar[0];?>"></p></td>
                                <td><p id="multa<?php echo $livro_mostrar[0];?>"></p></td>
                            </tr>
                              <script>
                                let id<?php echo $livro_mostrar[0];?> = <?php echo $livro_mostrar[0];}?>

                                function diasRestantes(){
                                  let date1 = new Date();
                                  let date2 = new Date('<?php echo $usuario_mostrar[3]?>');

                                  // Calculating the time difference
                                  // of two dates
                                  let diferencaTempo= date2.getTime() - date1.getTime();

                                  // Calculating the no. of days between
                                  // two dates
                                  var diferencaDias = Math.round(diferencaTempo / (1000 * 3600 * 24));

                                  return diferencaDias + 1;
                                }

                                  // To display the final no. of days (result)
                                  document.getElementById("dias_restantes" + id<?php echo $livro_mostrar[0];?>).innerHTML = diasRestantes();

                                function calculaMulta(diferenca){
                                  if(diferenca < 0){
                                    return "R$ " + diferenca * 1.5 * -1;
                                  }
                                  else {
                                    return "Sem multa";
                                  }
                                  ...
                                  document.getElementById("multa" + id<?php echo $livro_mostrar[0];?>).innerHTML = calculaMulta(diasRestantes());
                              </script>
                        </form>
                        <?php
                    }
