      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            <li>
              <a href="menu_User.php" class="nav-link text-white">
                <img class="bi d-block mx-auto mb-1" width="30" height="30" src="img/homeicon.png" alt="">
                Home
              </a>
            </li>
            <li>
              <a href="menu_User.php#livros" class="nav-link text-white">
               <img class="bi d-block mx-auto mb-1" width="30" height="30" src="img/livrosicon.png" alt="">
                Livros
              </a>
            </li>
            <li>
              <a href="menu_User.php#emprestimos" class="nav-link text-white">
...
<div class="container mt-5">
    ...
    <form method="POST" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="rg" name="rg" value="<?php echo  $_SESSION['Rg_User']; ?>" maxlength="12" OnKeyPress="formatar('##.###.###-##',this)" required>
        </div>
        <div class="col-md-6">
            <label for="cpf" class="form-label">CPF</label>
            <input type="text" class="form-control" id="cpf" name="cpf" value="<?php echo $_SESSION['Cpf_User']; ?>" maxlength="14" OnKeyPress="formatar('###.###.###-##',this)" required>
        </div>
        <div class="col-md-6">
            <label for="telefone" class="form-label">Telefone</label>
            <input type="text" class="form-control" id="telefone" name="telefone" value="<?php echo $_SESSION['Telefone_User']; ?>" maxlength="15" OnKeyPress="formatar('(##) #####-####',this)" required>
        </div>
        <div class="col-md-6">
