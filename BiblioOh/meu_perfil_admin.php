...
<head>
    ...
    <title>BlibioOH - Meu Perfil </title>
...
<div class="container mt-5">
    ...
    <form method="POST" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="rg" name="rg" value="<?php echo  $_SESSION['Rg_Func']; ?>" maxlength="12" OnKeyPress="formatar('##.###.###-##',this)" required>
        </div>
        <div class="col-md-6">
            <label for="cpf" class="form-label">CPF</label>
            <input type="text" class="form-control" id="cpf" name="cpf" value="<?php echo $_SESSION['Cpf_Func']; ?>" maxlength="14" OnKeyPress="formatar('###.###.###-##',this)" required>
        </div>
        <div class="col-md-6">
            <label for="dataNascimento" class="form-label">Data de Nascimento</label>
            <input type="date" class="form-control" id="dataNascimento" name="dataNascimento" value="<?php echo $_SESSION['Data_Nascimento']; ?>" maxlength="15" OnKeyPress="formatar('(##) #####-####',this)" required>
        </div>
        <div class="col-md-6">
            <label for="dataAdmissao" class="form-label">Data de Admissão</label>
            <input type="date" class="form-control" id="dataAdmissao" name="dataAdmissao" value="<?php echo $_SESSION['Data_Admissao']; ?>" maxlength="15" OnKeyPress="formatar('(##) #####-####',this)" required>
        </div>
        <div class="col-md-6">
            <label for="endereco" class="form-label">Enderço</label>
            <input type="text" class="form-control" id="endereco" name="endereco" value="<?php echo $_SESSION['Telefone_Func']; ?>" maxlength="15" OnKeyPress="formatar('(##) #####-####',this)" required>
        </div>
        <div class="col-md-6">
            <label for="telefone" class="form-label">Telefone</label>
            <input type="text" class="form-control" id="telefone" name="telefone" value="<?php echo $_SESSION['Telefone_Func']; ?>" maxlength="15" OnKeyPress="formatar('(##) #####-####',this)" required>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="password" class="form-control" id="senha" name="senha" value="<?php echo $_SESSION['Senha_Func']; ?>" required>
        </div>
        <div class="col-12">
