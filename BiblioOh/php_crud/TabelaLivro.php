        ...
        <div class="modal-body">
            <form class="row g-3" id="alt-livro-form" method="post">
                ...
                <div class="col-12">
                    ...
                    <input type="number" name="qtdePaginas" class="form-control" id="qtdePaginas" placeholder="Quantidade de páginas" required>
                </div>
                <div class="col-12">
                    <label for="exemplares" class="form-label">Exemplares</label>
                    <input type="number" name="exemplares" class="form-control" id="exemplares" placeholder="Quantidade de exemplares" required>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="isbn" class="form-control" id="isbn" placeholder="ISBN do livro" maxlength="13" required>
                </div>
                <div class="col-12">
