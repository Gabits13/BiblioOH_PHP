        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" id="cad-usuario-form" method="post">
                    ...
                    <div class="col-12">
                        <label for="rg" class="form-label">RG</label>
                        <input type="text" name="rg" class="form-control" id="rg" placeholder="xx.xxx.xxx-xx" required>
                    </div>
                    <div class="col-12">
                        <label for="cpf" class="form-label">CPF</label>
                    ...
                    <div class="col-12">
                        <label for="telefone" class="form-label">Telefone</label>
                        <input type="text" name="telefone" class="form-control" id="telefone" placeholder="(xx) xxxxx-xxxx" required>
                    </div>
                    <div class="col-12">
                        <label for="email" class="form-label">Email</label>
